...
public static b4j.example.helpdialog _helpdialog = null;
  public Object[] GetGlobals() {
		return new Object[] {"HelpDialog",Debug.moduleToString(b4j.example.helpdialog.class),"Main",Debug.moduleToString(b4j.example.main.class),"PatternMashine",Debug.moduleToString(b4j.example.patternmashine.class)};
}
}